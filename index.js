 ...
 function toggle(){
    ...
    document.getElementById("nav-el").style="position: fixed;top:20%; height:fit-content;width: 100%;  color: #ffffff; border-radius:8px;"
    ...
    document.getElementById("times-el").addEventListener('click' , function(){
        ...
        document.getElementById("nav-el").style.cssText="position: fixed;top:-190%; height:  fit-content;width: 100vw;  color: #ffffff;"
    })
